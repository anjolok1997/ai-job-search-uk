...
The original framework was built and proven by its author, **Mads Lorentzen**, on his own job search. In his words:
...
*The longer version, including the full application funnel, is on [Mads' LinkedIn](https://www.linkedin.com/in/mads-lorentzen/). This UK fork is an independent adaptation and is not maintained by Mads.*
